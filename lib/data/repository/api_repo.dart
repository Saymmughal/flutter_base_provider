...
import 'package:flutter_base_provider/view/widgets/extention/object_extension.dart';
import 'package:flutter_base_provider/view/widgets/show_message_dialog.dart';
...
class ApiRepo {
  ...
  postRequest({
    ...
    try {
      ...
      final response = await dio.post(
        url,
        data: isFormData == true ? formData : data,
      );
  ...
  void showError(String message, {VoidCallback? onTap}) {
    showMessageDialog(message: message, onTap: onTap);
  }

  Future<dynamic> dioError(DioException exception) async {
      ...
      Future.delayed(Duration.zero, () {
        switch (exception.type) {
          ...
          case DioExceptionType.connectionTimeout:
            ...
            break;
          default:
            showError(AppConstant.badResponseMessage);
            break;
        }
      });
    }
